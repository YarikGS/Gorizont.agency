 ...
 */
$config['site_title']                 = "Gorizont";       // Site Title, example.com
$config['admin_email']                = "admin@psycle"; // Admin Email, admin@example.com
...
/*
 ...
 | Default: auth/
 */
$config['email_templates'] = 'psycle/email/';
...
$config['email_new_consultation'] = 'new_consultation.tpl.php';
/*
 | -------------------------------------------------------------------------
 | Message Delimiters.
 | -------------------------------------------------------------------------
