...
$lang['double_ip']                              = 'С вашего айпи уже зарегистрирован аккаунт';
...
$lang['activation_email_successful'] 	  	 = 'Сообщение об активации отправлено на вашу почту. Проверьте папку Входящие или Спам';
...
$lang['email_activate_welcome']    = 'Вас приветствует сервис Bboard.';
$lang['email_activate_heading']    = 'Чтобы закончить регистрацию аккаунта с именем  %s';
$lang['email_activate_subheading'] = 'Нажмите на ссылку чтобы %s.';
$lang['email_activate_link']       = 'активировать ваш акаунт';

// Forgot Password Email
$lang['email_forgotten_password_subject'] = 'Восстановление забытого пароля';
$lang['email_forgot_password_welcome']    = 'Вас приветствует сервис Bboard.';
$lang['email_forgot_password_heading']    = 'Вы запросили сброс пароля для пользователя %s';
